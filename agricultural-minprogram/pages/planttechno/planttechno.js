...
Page({
  ...
  data: {
    ...
    technoData:[
      {
        id:0,
        img:IP+"/assets/images/arg_collect.png",
        desc:"收藏"
      },
      {
        id:1,
        img:IP+"/assets/images/arg_comment.png",
        desc:"评论"
      },
      {
        id:2,
        img:IP+"/assets/images/arg_like_active.png",
        desc:"喜欢"
      },
    ],
  ...
  handleDetail() {
    wx.navigateTo({
      url: '/pages/soilrentdetail/soilrentdetail',
    })
  },
